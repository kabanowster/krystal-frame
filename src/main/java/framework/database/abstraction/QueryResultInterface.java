...
import framework.database.persistence.PersistenceInterface;
...
public interface QueryResultInterface {
	...
	/**
	 * Overload method for {@link PersistenceInterface#mapQueryResult(QueryResultInterface, Class) PersistenceInterface.mapQueryResult()}.
	 * Easily transform rows and columns to objects.
